...
class OutletCategoryTransformer extends Fractal\TransformerAbstract
{
    private $_middleUrl = "";
    ...
    private function getSubCategories($categories) {
        ...
        foreach($categories as $category) {
            $data[] = [
                ...
                "status" => (integer) $category->status,
    ...
    public function transform(OutletCategory $category)
    {
        ...
        return [
            ...
            "links" => [
                "self" => $this->_middleUrl . "/outlet-category/{$category->guid}",
            ]
        ];
    }
}
